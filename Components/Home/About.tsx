...
const About: React.FC = () => {
    return (
        <div className=' md:w-[full] py-4 px-4 md:px-14 '>
            <h1 className='md:text-[3vw] font-bold text-center text-baseColor overflow-hidden text-[7vw]'><u><Bounce>ABOUT US</Bounce></u></h1>
            <div className="md:flex md:h-[50vh] md-w-[100vw] items-center md:mt-14 justify-between overflow-hidden">
                ...
                <div className='h-[100%] md:w-[48%] flex flex-col  justify-center'>
                    <h2 className='md:text-[2vw] font-bold text-baseColor text-[5vw]'><u><JackInTheBox>Who I Am</JackInTheBox></u></h2>
                    <Fade>
            ...
            <div className="md:flex md:h-[50vh] md-w-[100vw] items-center md:mt-14 justify-between">
                ...
                <div className='h-[100%] md:w-[48%] flex flex-col  justify-center '>
                    <h2 className='md:text-[2vw] font-bold text-baseColor text-[5vw]'><u><Bounce>My Approach</Bounce></u></h2>
            ...
            <div className="md:flex md:h-[50vh] md-w-[100vw] items-center md:mt-14 justify-between">
                <div className='h-[100%] md:w-[48%] flex flex-col  justify-center '>
                    <h2 className='md:text-[2vw] text-[5vw] font-bold text-baseColor'><u><Bounce>Why I Love Front-End Development</Bounce></u></h2>
            ...
            <div className="md:flex md:h-[50vh] md-w-[100vw] items-center md:mt-14 justify-between">
                ...
                <div className='h-[100%] md:w-[48%] flex flex-col  justify-center'>
                    <h2 className='md:text-[2vw] text-[5vw] font-bold text-baseColor'><u><Bounce>Continuous Learning</Bounce></u></h2>
